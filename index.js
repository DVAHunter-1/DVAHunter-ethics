window.onload = function () {
    document.getElementById("main-content").innerHTML = `
        ...
        <section>
            <h2>Contact Us</h2>
            <p>If you have any questions or do not wish us to scan your domain, please feel free to contact us at <a href="mailto:xx@gmail.com">dvahunter@gmail.com</a>.</p>
        </section>
    `;
};
